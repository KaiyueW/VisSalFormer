...
class ChartQAKNNRetriever:
    ...
    def _precompute_text_features(self):
        ...
        return self._encode_texts_openai(all_queries)
    ...
    def retrieve(self, test_image, test_query, num_examples, do_reverse=False):
        ...
        with torch.no_grad():
            ...
            query_text_feat = self._encode_texts_openai([test_query])          # [1, D_text]
...
if __name__ == "__main__":
    ...
    run(
        ...
        output_json="output/weighted_siglip_openai_fusion_fewshot_examples.json",
        num_shots=8,
        cached_image_features="siglip_train_image_feats.pt",
        save_image_features="siglip_train_image_feats.pt",
        cached_text_features="openai_train_text_feats.pt",
        save_text_features="openai_train_text_feats.pt", 
        w1=0.5, 
        w2=0.5,  
    )